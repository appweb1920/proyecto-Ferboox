        ...
        <div class="bg-light">
            ...
            <div class="contenedorTabla">
                ...
                <div class="table-responsive-sm ">
                    ...
                    <a href="/pdf/descargaCotizacion/{{$pdf->id}}"><button class="btn btn-outline-primary my-2 my-sm-0">Descargar</button></a>
                   <a href="/"><button class="btn btn-outline-danger my-2 my-sm-0">Salir</button></a>
                </div>
            </div>
        </div>
